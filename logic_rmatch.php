...
// 1. create new row (romantic (1), friendship (0), created at (timestamp)
...
$stmt_upd = $conn->prepare("UPDATE matches SET romantic=1, created_at=CURRENT_TIMESTAMP WHERE
