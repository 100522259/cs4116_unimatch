...
$stmt_ins = $conn->prepare("INSERT INTO offense (user_id, phone_warning, offense_num, blocked, reported, last_modified)
...
$stmt_upd = $conn->prepare("UPDATE offense SET reported=?
    WHERE user_id = ?");
